...
public class MainActivity extends AppCompatActivity implements AvmRuntime.ActionListener {
    ...
    protected void onRestart() {
        super.onRestart();
        Log.i("AvmRuntime", "MainActivity::onRestart()");
    }

    protected void onResume() {
        super.onResume();
        Log.i("AvmRuntime", "MainActivity::onResume()");
        isOnResume = true;
    ...
    private boolean updateLayer() {
        Log.i("AvmRuntime", "isRearGearSts : " + AvmRuntime.self().isRearGearSts() + " , getFullSceneSts is " + AvmRuntime.self().getFullSceneSts());
        if (AvmRuntime.self().isRearGearSts() || AvmRuntime.self().getFullSceneSts() == DataDefine.FV_STATE_LEFT_CARD) {
            Log.i("AvmRuntime", "start read Surface control.");
            if (CameraView.windowSurfaceControl == null)
                CameraView.windowSurfaceControl = getSurfaceControl(AvmApp.getInstance().getCameraView().getRootView());
            Log.i("AvmRuntime", "widnowSurfaceControl is " + CameraView.windowSurfaceControl);
            if (CameraView.windowSurfaceControl != null) {
    ...
    private SurfaceControl getSurfaceControl(View overlayView) {
        ...
        try {
            ...
            Log.i("AvmRuntime", "viewClassOvelay is " + viewClassOvelay);
            // 反射获取ViewRootImpl对象
            ...
            Log.i("AvmRuntime", "viewRootImpl is " + viewRootImpl);
            ...
            Log.i("AvmRuntime", "viewRootImplclass is " + viewRootImplclass);
    ...
    private SurfaceControl getSurfaceControl() {
        ...
        try {
            Window window = getWindow();
            Log.i("AvmRuntime", "window is " + window);
            View decorView = window.getDecorView();
            Log.i("AvmRuntime", "decorView is " + decorView);
