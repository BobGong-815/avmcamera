...
//        AvmRuntime.self().radarChange(true);
    ...
    public void doorStatus(int vehicleId, int val) {
        ...
        int doors[] = {CanManager.getInstance().getIntStatus(CABIN_DOOR_OPEN_STATUS, isRightEEA ? ROW_1_RIGHT : ROW_1_LEFT),
                ...
                CanManager.getInstance().getIntStatus(CABIN_DOOR_OPEN_STATUS, isRightEEA ? ROW_2_RIGHT : ROW_2_LEFT),
                CanManager.getInstance().getIntStatus(CABIN_DOOR_OPEN_STATUS, isRightEEA ? ROW_2_LEFT : ROW_2_RIGHT),
