...
public class NotCloseToast {

    private Handler mHandler = new Handler(Looper.getMainLooper());
    private static NotCloseToast instance;
    private TextView text;
    private Context mContext;
    private View mView;


    public static NotCloseToast getInstance() {
        if (instance == null)
            instance = new NotCloseToast();
        return instance;
    }

    public NotCloseToast() {
    }

    public void init(View view) {
        this.mView = view;
        mContext = view.getContext();
        text = (TextView) view.findViewById(R.id.toast_nc_text);
        text.setText("");
